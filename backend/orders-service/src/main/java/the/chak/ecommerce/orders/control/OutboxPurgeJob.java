...
/**
 * Order-specific outbox purge. The retention logic lives in {@link AbstractOutboxPurgeJob}; this
...
public class OutboxPurgeJob extends AbstractOutboxPurgeJob {
    ...
    @ConfigProperty(name = "orders.outbox.retention", defaultValue = "P7D")
    Duration retention;

    @Scheduled(every = "{orders.outbox.purge-interval}",

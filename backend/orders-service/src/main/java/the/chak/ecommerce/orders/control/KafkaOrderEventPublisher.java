...
public class KafkaOrderEventPublisher {
    ...
    /**
     * Publishes an {@code order-initiated} event with the given Kafka message key. The returned
     * future completes when the broker acks (or completes exceptionally on nack).
     */
    public CompletableFuture<Void> publishOrderInitiated(OrderDTO order, String key) {

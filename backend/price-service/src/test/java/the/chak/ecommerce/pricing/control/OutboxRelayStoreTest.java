...
/**
 * Plain unit tests for the price relay's Mongo storage glue. The shared batch loop and broker-outage
...
class OutboxRelayStoreTest {
    ...
    private OutboxEntry entry() {
        ...
        entry.aggregateType = "product";
        entry.aggregateId = "p1";
        entry.eventType = "price-changed";
        entry.topic = "price-changed";
        entry.payload = "{\"product_id\":\"p1\"}";
